...
<img src="images/创建开发环境对话框.png" width="1000px" />
...
**步骤 3**  &#160; &#160; 训练作业执行完成后，在“训练作业管理”界面，单击iceberg_predict作业名称，进入作业的详情界面。在“训练日志”中，可以查看到在eval数据集上的loss值为0.295，如图6。在“automation/log”目录下，能看到用于保存预测结果的“submission.csv”文件。
