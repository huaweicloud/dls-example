...
**步骤 2**	参考<a href = "https://support.huaweicloud.com/usermanual-dls/dls_01_0040.html">3.1 上传业务数据</a>，将数据集上传至华为云OBS桶中（假设OBS桶路径为：“s3://automation/data”）。 
...
**步骤 1**   参考3.2 访问深度学习服务，登录“深度学习服务”管理控制台，单击左侧导航栏的“开发环境管理”。
...
图1.“拷贝至OBS桶”对话框
<img src="images/模型导入至OBS桶.png" width="1000px" />

**步骤 3**	在“预置模型库”界面，单击“ResNet_v1\_50”所在行右侧的“创建训练作业”，进入“创建训练作业”界面。

**步骤 4**	参考图4-1完成作业参数配置。其中，“代码目录”和“启动文件”无需用户填写，“训练数据集”请选择训练集的存储路径，“train_url”为模型保存路径。其他运行参数详情，请参考<a href="https://support.huaweicloud.com/usermanual-dls/dls_01_0074.html">6.11.1 运行参数列表</a>。
...
**步骤 3**	参考图4-4完成参数配置。其中，“使用模型”为模型存放路径，请参考训练作业中运行参数“train_url”的值。
...
### 5. 访问服务
当预测作业的状态处于“运行中”，表示预测服务已部署，如图4-5。
